...
public class Student extends People implements Serializable
{
   ...
   public boolean saveTest(java.sql.Date testDate, String time, String temperature)
   {
      ...
      {
         System.out.println("massa corporal faltando");
         return false;
      }
      else
      {
                     ...
                     else
                     {
                        ...
                        else
                        {
                           ...
                           else
                           {
                              ...
                              {
                                 if(Interface.TestPanel.getRadioSitAndAchieveWithSeat())
                                 {
                                    test.setSentarEAlcancarComBanco(true);
                                 }
                                 else
                                 {
                                    test.setSentarEAlcancarComBanco(false);
                                 }
                                          ...
                                          else
                                          {
                                             ...
                                             else
                                             {
                                                ...
                                                else
                                                {
                                                   ...
                                                   System.out.println("sentar e alcançar = " + test.getSentarEAlcancar() + "com banco = " 
                                                                      + test.isSentarEAlcancarComBanco());
